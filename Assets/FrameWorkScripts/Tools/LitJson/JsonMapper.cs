    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue (Type inst_type, JsonReader reader)
        {
            ...
            if (reader.Token == JsonToken.ArrayStart) {
				...
				{
					if( reader.Value.ToString() == "JsonClassType" && reader.Read())
					{
						inst_type = Type.GetType(reader.Value.ToString());
					}
				}
                                        ...
                                        int depth)
        {
            ...
            writer.WriteObjectStart ();
			writer.WritePropertyName ("JsonClassType");
			writer.Write(obj_type.ToString());
